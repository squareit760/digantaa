...
!(function (n, i, a, e) {
  (n.navigation = function (t, s) {
    ...
    r.settings = {};
    n(t);
    n((t = t)).find(".nav-search").length > 0 &&
      n(t)
        .find(".nav-search")
        .find("form")
        .prepend(
      ...
      (r.init = function () {
        (r.settings = n.extend({}, o, s)),
          ...
          n(t)
            ...
            .on("click touchstart", function (n) {
              n.stopPropagation(),
                n.preventDefault(),
                r.showOffcanvas(),
                s !== e && r.callback("onShowOffCanvas");
            }),
          n(t)
            .find(".nav-menus-wrapper-close-button")
            .on("click touchstart", function () {
              r.hideOffcanvas(), s !== e && r.callback("onHideOffCanvas");
            }),
          n(t)
          ...
          n(i).resize(function () {
            r.initNavigationMode(p()), C(), r.settings.hiddenOnMobile && m();
          }),
          r.initNavigationMode(p()),
          r.settings.hiddenOnMobile && m(),
          r.settings.overlay &&
            n(t).append("<div class='nav-overlay-panel'></div>"),
          n(t).find(".megamenu-tabs").length > 0 && w(),
          s !== e && r.callback("onInit");
      });
    var h = function () {
    ...
    (r.showSubmenu = function (i, a) {
      p() > r.settings.mobileBreakpoint &&
    ...
    var g = function () {
      r.settings.hideScrollBar && n("body").removeClass("no-scroll"),
        r.settings.overlay && n(t).find(".nav-overlay-panel").fadeOut(400);
    };
      ...
      (r.toggleOffcanvas = function () {
        p() <= r.settings.mobileBreakpoint &&
          (n(t).find(".nav-menus-wrapper").hasClass("nav-menus-wrapper-open")
            ? (r.hideOffcanvas(), s !== e && r.callback("onHideOffCanvas"))
            : (r.showOffcanvas(), s !== e && r.callback("onShowOffCanvas")));
      }),
    ...
    var p = function () {
        return (
          i.innerWidth || a.documentElement.clientWidth || a.body.clientWidth
        );
      },
      b = function (i) {
        "landscape" == i
          ? n(t).find(".nav-menu").find("li, a").off(l)
          : n(t).find(".nav-menu").find("li, a").off(c).off(f);
      },
      C = function () {
      ...
      w = function () {
        function i(i) {
          var a = n(i).children(".megamenu-tabs-nav").children("li"),
            e = n(i).children(".megamenu-tabs-pane");
          n(a).on("mouseenter.tabs click.tabs touchstart.tabs", function (i) {
            i.stopPropagation(),
              i.preventDefault(),
              n(a).removeClass("active"),
              n(this).addClass("active"),
              n(e).hide(0).removeClass("active"),
              n(e[n(this).index()]).show(0).addClass("active");
          });
        }
        if (n(t).find(".megamenu-tabs").length > 0)
          for (var a = n(t).find(".megamenu-tabs"), e = 0; e < a.length; e++)
            i(a[e]);
      },
      O = function () {
        b("landscape"),
  ...
  $("#navigation4").navigation({ overlayColor: "rgba(140,193,82,0.8)" }),
